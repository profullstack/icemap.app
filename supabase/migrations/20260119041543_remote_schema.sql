...
CREATE OR REPLACE FUNCTION "public"."can_user_post"("p_fingerprint" "text", "p_window_seconds" integer DEFAULT 3600) RETURNS boolean
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."can_user_post"("p_fingerprint" "text", "p_window_seconds" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."find_subscriptions_for_post"("p_lat" double precision, "p_lng" double precision) RETURNS TABLE("id" "uuid", "fingerprint" "text", "push_endpoint" "text", "push_p256dh" "text", "push_auth" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."find_subscriptions_for_post"("p_lat" double precision, "p_lng" double precision) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."generate_anonymous_id"() RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."generate_anonymous_id"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_or_create_anonymous_id"("p_fingerprint" "text") RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_anonymous_id TEXT;
...
ALTER FUNCTION "public"."get_or_create_anonymous_id"("p_fingerprint" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_post_vote_count"("p_post_id" "uuid") RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN COALESCE(
...
ALTER FUNCTION "public"."get_post_vote_count"("p_post_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."record_post"("p_fingerprint" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."record_post"("p_fingerprint" "text") OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."anonymous_users"
    ADD CONSTRAINT "anonymous_users_pkey" PRIMARY KEY ("fingerprint");
...
ALTER TABLE ONLY "public"."favorites"
    ADD CONSTRAINT "favorites_post_id_fingerprint_key" UNIQUE ("post_id", "fingerprint");
...
ALTER TABLE ONLY "public"."rate_limits"
    ADD CONSTRAINT "rate_limits_pkey" PRIMARY KEY ("fingerprint");
...
ALTER TABLE ONLY "public"."votes"
    ADD CONSTRAINT "votes_post_id_fingerprint_key" UNIQUE ("post_id", "fingerprint");



CREATE INDEX "comments_fingerprint_idx" ON "public"."comments" USING "btree" ("fingerprint");
...
CREATE INDEX "favorites_fingerprint_idx" ON "public"."favorites" USING "btree" ("fingerprint");
...
CREATE INDEX "posts_expires_at_idx" ON "public"."posts" USING "btree" ("expires_at");



CREATE INDEX "posts_fingerprint_idx" ON "public"."posts" USING "btree" ("fingerprint");



CREATE INDEX "posts_incident_type_idx" ON "public"."posts" USING "btree" ("incident_type");
...
CREATE INDEX "subscriptions_fingerprint_idx" ON "public"."subscriptions" USING "btree" ("fingerprint");



CREATE INDEX "votes_fingerprint_idx" ON "public"."votes" USING "btree" ("fingerprint");
...
GRANT ALL ON FUNCTION "public"."can_user_post"("p_fingerprint" "text", "p_window_seconds" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."can_user_post"("p_fingerprint" "text", "p_window_seconds" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_user_post"("p_fingerprint" "text", "p_window_seconds" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."find_subscriptions_for_post"("p_lat" double precision, "p_lng" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."find_subscriptions_for_post"("p_lat" double precision, "p_lng" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."find_subscriptions_for_post"("p_lat" double precision, "p_lng" double precision) TO "service_role";



GRANT ALL ON FUNCTION "public"."generate_anonymous_id"() TO "anon";
GRANT ALL ON FUNCTION "public"."generate_anonymous_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_anonymous_id"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_or_create_anonymous_id"("p_fingerprint" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_or_create_anonymous_id"("p_fingerprint" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_or_create_anonymous_id"("p_fingerprint" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_post_vote_count"("p_post_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_post_vote_count"("p_post_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_post_vote_count"("p_post_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."record_post"("p_fingerprint" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."record_post"("p_fingerprint" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."record_post"("p_fingerprint" "text") TO "service_role";
